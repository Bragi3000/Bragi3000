      ...
      <div className="relative p-4 w-full max-w-md h-full md:h-auto">
        <div className="relative rounded-lg shadow bg-gray-700">
          ...
          <div className="p-6 text-center">
            ...
            <h3 className="mb-5 text-lg font-normal text-gray-400">Are you sure you want to reset the playlist?</h3>
            <button type="button"
            ...
            <button type="button"
              className="focus:ring-4 focus:outline-none rounded-lg border text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 bg-gray-700 text-gray-300 border-gray-500 hover:text-white hover:bg-gray-600 focus:ring-gray-600"
              onClick={onCancel}>
              No, cancel
            </button>
          </div>
