  ...
  return (
    <>
      <div className="container mx-auto px-5 my-40 text-center">
        ...
        <p className="text-3xl mb-6 text-gray-200 w-192">
          Give everyone the chance to hear their favorite song
        </p>
        <p className="text-xl mb-6 text-gray-400 mx-auto w-128">
          Two people select a song from Spotify.
          Afterwards they play a fun minigame.
          The song chosen by the winner is added to the queue, while
      ...
      <img src={kermit} className="fixed bottom-0 w-80 right-0 animate-kermit" alt={"kermit"}/>
    </>
  );
};
